...
public class ListenerMux implements ExoPlayerListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener,
        MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, OnBufferUpdateListener, MetadataListener, MediaPlayer.OnInfoListener {
    ...
    @Nullable
    private InfoUpdateListener infoUpdateListener;
    ...
    public void onStateChanged(boolean playWhenReady, int playbackState) {
        ...
        //Updates about the State
        if (infoUpdateListener != null) {
            infoUpdateListener.onInfoUpdate(playbackState, 0);
        }
    }
    ...
    /**
     * Sets the listener to inform of Current Playback updates
     *
     * @param listener The listener to inform
     */
    public void setInfoUpdateListener(@Nullable InfoUpdateListener listener) {
    ...
    public boolean onInfo(MediaPlayer mediaPlayer, int i, int i1) {
        if (infoUpdateListener != null)
            infoUpdateListener.onInfoUpdate(i, i1);
