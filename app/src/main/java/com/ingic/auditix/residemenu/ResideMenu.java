package com.ingic.auditix.residemenu;
  ...
  /*  public List<ResideMenuItem> getMenuItems(int direction) {
    ...
    public void openMenu(final String direction) {
        ...
        try {
            ...
            // For Inner Screen Scaling 0.84 default
...
//            Blurry.delete(context.getContentView());
    ...
    private AnimatorSet buildScaleDownAnimation(View target, float targetScaleX, float targetScaleY) {
        try {
            ...
            if (mUse3D) {
                int angle = scaleDirection.equals(SideMenuDirection.LEFT.getValue()) ? -ROTATE_Y_ANGLE : ROTATE_Y_ANGLE;
    ...
    private void setScaleDirectionByRawX(float currentRawX) {
        if (currentRawX < lastRawX)
            setScaleDirection(SideMenuDirection.RIGHT.getValue());
        else
            setScaleDirection(SideMenuDirection.LEFT.getValue());
    }

    private float getTargetScale(float currentRawX) {
        float scaleFloatX = ((currentRawX - lastRawX) / getScreenWidth()) * 0.75f;
        scaleFloatX = scaleDirection.equals(SideMenuDirection.RIGHT.getValue()) ? -scaleFloatX : scaleFloatX;
