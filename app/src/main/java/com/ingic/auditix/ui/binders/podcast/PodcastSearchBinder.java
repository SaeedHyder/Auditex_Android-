 ...
 * Created on 7/11/18.
 */
public class PodcastSearchBinder extends RecyclerViewBinder<PodcastDetailHomeEnt> implements View.OnClickListener {
    private ImageLoader imageLoader;
    private DisplayImageOptions options;
    private RecyclerViewItemListener listener;

    public PodcastSearchBinder(DisplayImageOptions options, RecyclerViewItemListener listener) {
