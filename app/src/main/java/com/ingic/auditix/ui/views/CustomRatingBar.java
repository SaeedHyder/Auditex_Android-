...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.orange_star_big;
    private int mStarOffResource = R.drawable.grey_star_big;
    private int mStarHalfResource = R.drawable.orange_star_big;
