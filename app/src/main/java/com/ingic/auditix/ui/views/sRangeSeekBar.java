 ...
 */
public class sRangeSeekBar<T extends Number> extends ImageView {
    /**
     * Default color of a {@link sRangeSeekBar}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    ...
    public sRangeSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public sRangeSeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.circle_orange;
        int thumbPressed = R.drawable.circle_orange;
        int thumbDisabled = R.drawable.circle_orange;
        ...
        if (attrs == null) {
            ...
            try {
                ...
                showLabels = a.getBoolean(R.styleable.sRangeSeekBar_showLabels, true);
    ...
    public interface OnRangeSeekBarChangeListener<T extends Number> {
        ...
        void onRangeSeekBarValuesChanged(sRangeSeekBar<T> bar, T minValue, T maxValue);
    }
