...
public class PodcastDownloadBinder extends RecyclerViewBinder<PodcastEpisodeEnt> implements View.OnClickListener {
    private final ViewBinderHelper viewBinderHelper = new ViewBinderHelper();
    private RecyclerViewItemListener downloadListner;
    private DisplayImageOptions options;
    private ImageLoader imageLoader = ImageLoader.getInstance();

    public PodcastDownloadBinder(RecyclerViewItemListener downloadListner, DisplayImageOptions options) {
    ...
    public void bindView(PodcastEpisodeEnt entity, int position, Object viewHolder, Context context) {
        ...
        holder.txtDurationText.setVisibility(View.GONE);
